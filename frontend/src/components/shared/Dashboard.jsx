...
function Dashboard({ className }) {
    ...
    return (<aside aria-label="sidebar" aria-controls="default-sidebar" className={`${className} bg-white font-urbanist w-[290px] px-6 shadow-md rounded-md transition-transform -translate-x-full sm:translate-x-0`}>
      ...
      <div className="wrapper pt-6">
        <ul>
          {dashboardItems.map((item) => (<li key={item.title}>
              <Link to={item.link} className="flex mb-4 items-center px-4 py-3 rounded-xl text-slate-700 hover:bg-main hover:text-white transition duration-150 cursor-pointer">
                <i>
          ...
          <li>
            <div onClick={logout} className="flex mb-4 items-center px-4 py-3 rounded-xl text-slate-700 hover:bg-main hover:text-white transition duration-150 cursor-pointer">
              <i>

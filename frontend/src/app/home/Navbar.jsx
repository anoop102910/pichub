    ...
    return (<>
      <header className="sticky z-[10] top-0 left-0 w-full gap-4 h-16 rounded-md shadow-md bg-white flex items-center px-6 justify-between">
        <div className="sm:w-[35vw] w-[55vw] rounded-md flex gap-4 px-4 items-center bg-slate-100 py-2">
          ...
          <input className="bg-inherit outline-none w-full text-slate-700" placeholder="Search..." type="search" value={query} onChange={e => dispatch(setQuery(e.target.value))}/>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          {/* upload image */}
          {isAuthenticated ? (<div className="flex gap-4 justify-center items-center">

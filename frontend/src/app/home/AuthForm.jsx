        ...
        <div className="space-y-4">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input id="email" placeholder="Your email address" type="email" required value={formData.email} onChange={handleChange}/>
            </div>
            <div className="space-y-2">
              <label htmlFor="password" className="text-sm font-medium text-gray-700">
                Password
              </label>
              <Input id="password" placeholder="Your password address" type="password" required value={formData.password} onChange={handleChange}/>
            </div>

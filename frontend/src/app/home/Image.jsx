    ...
    return (<Dialog>
      <DialogTrigger onClick={() => incrementViews(image._id)} asChild>
        <div className="relative">
          <img className="w-full rounded-md object-cover" src={getImageUrl("image", image.imageUrl)} alt=""/>
      ...
      <DialogContent>
        <ScrollArea className="max-h-[80dvh]">
          <div>
            <img className="w-full h-[80%] object-contain" src={getImageUrl("image", image.imageUrl)} onError={e => {
